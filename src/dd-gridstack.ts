	...
	public on(el: GridItemHTMLElement, name: string, callback: DDCallback): DDGridStack {
		this._getDDElements(el).forEach((dEl) =>
			dEl.on(name, (event: Event) => {
				callback(event, DDManager.dragElement ? DDManager.dragElement.el : (event.target as GridItemHTMLElement), DDManager.dragElement ? DDManager.dragElement.helper : null);
			}),
		);
		return this;
	}
...
GridStack.prototype._setupAcceptWidget = function (this: GridStack): GridStack {
	...
	dd.droppable(this.el, {
		...
		.on(this.el, 'drop', (event, el: GridItemHTMLElement, helper: GridItemHTMLElement) => {
			...
			this._triggerChangeEvent(); // @ts-ignore
...
GridStack.prototype._dragOrResize = function (this: GridStack, el: GridItemHTMLElement, event: MouseEvent, ui: DDUIData, node: GridStackNode, cellWidth: number, cellHeight: number) {
